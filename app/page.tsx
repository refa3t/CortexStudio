...
const projects = [
  {n:"01",name:"BellaCity",long:"Factory ERP",kind:"INDUSTRIAL SYSTEM",sector:"Industry",color:"#efece4",mark:"BC",image:"/projects/bellacity-logo-hd.png",copy:"One operational brain for three plastics factories.",detail:"Production · Machines · Materials · Maintenance · HR",stack:"FLUTTER / NODE.JS / POSTGRESQL",status:"IN PRODUCTION"},
  {n:"02",name:"QuickServe",long:"Ordering Website & Restaurant Cashier",kind:"CUSTOMER ORDERING WEBSITE + RESTAURANT POS",sector:"Hospitality",color:"#ff5b31",mark:"QS",image:"/projects/quickserve-brand-v2.png",copy:"A customer ordering website connected directly to the restaurant cashier, kitchen and delivery workflow—currently powering Qasr El Sham.",detail:"Customer ordering website · Restaurant cashier POS · Kitchen printing · Delivery · Analytics · Offline operation",stack:"FLUTTER / TYPESCRIPT / SOCKET.IO",status:"LIVE AT QASR EL SHAM"},
  {n:"03",name:"MarketPOS",long:"Super Cachir",kind:"SUPERMARKET POS",sector:"Retail",color:"#d8ff36",mark:"MP",image:"/projects/marketpos-brand-v2.png",copy:"From barcode to shelf intelligence in seconds.",detail:"Weight barcodes · FEFO · Dual stock · Thermal print",stack:"FLUTTER / DRIFT / ESC-POS",status:"LAUNCHING"},
  {n:"04",name:"PharmaPOS",long:"Pharmacy OS",kind:"HEALTHCARE POS",sector:"Healthcare",color:"#55e7ac",mark:"PP",image:"/projects/pharmapos-brand-v2.png",copy:"Expiry-aware pharmacy operations made beautifully simple.",detail:"Prescriptions · Suppliers · FIFO · Backups",stack:"FLUTTER / SQLITE / WIN32",status:"COMPLETED"},
  {n:"05",name:"Sports Print",long:"Cashier & Website",kind:"POS SYSTEM + E-COMMERCE WEBSITE",sector:"Retail",color:"#f3a8ff",mark:"SP",image:"/projects/sports-print-brand.png",copy:"A connected cashier system and online store for customized sportswear—from customer design to printing and delivery.",detail:"Cashier POS · E-commerce website · Product customization · Print queue · Unified inventory",stack:"FLUTTER WEB / NESTJS / RBAC",status:"IN DEVELOPMENT"},
  {n:"06",name:"RestoPOS",long:"Offline Cashier",kind:"RESTAURANT POS",sector:"Hospitality",color:"#ff9d2e",mark:"RP",image:"/projects/restopos-brand-v2.png",copy:"A focused cashier that needs no cloud to move fast.",detail:"Dine-in · Takeaway · Delivery · PDF receipts",stack:"FLUTTER / WINDOWS / OFFLINE",status:"COMPLETED"},
  {n:"07",name:"Coffee & Restaurant",long:"System",kind:"COFFEE & RESTAURANT SYSTEM",sector:"Hospitality",color:"#f2d6a2",mark:"CRS",image:"/projects/coffee-restaurant-system-brand.png",copy:"Tables, reservations and orders without the clutter.",detail:"Tables · Reservations · Staff · Expenses",stack:"FLUTTER / RIVERPOD / DRIFT",status:"COMPLETED"},
  {n:"08",name:"Suit Rental",long:"Rental Manager",kind:"SPECIALIZED OPERATIONS",sector:"Services",color:"#7cc4ff",mark:"SR",image:"/projects/suit-rental-brand.png",copy:"Every suit, booking and payment in its right place.",detail:"Bookings · Returns · Penalties · Reports",stack:"FLUTTER / ANDROID / WINDOWS",status:"COMPLETED"},
  {n:"09",name:"Overnice",long:"Travel",kind:"HOTEL DISCOVERY",sector:"Web",color:"#5be1ff",mark:"OT",image:"/projects/overnice-brand.png",copy:"Hotel discovery built for the Arabic traveler.",detail:"Search · Compare · Seasonal prices · Reviews",stack:"JAVASCRIPT / NETLIFY / VITEST",status:"LIVE",url:"https://overnicestore.netlify.app"},
  {n:"10",name:"Digital Menu",long:"Balcona",kind:"QR MENU + CMS",sector:"Web",color:"#ff7ca7",mark:"DM",image:"/projects/digital-menu-brand.png",copy:"The menu changes before the customer refreshes.",detail:"Categories · Products · Identity · Live updates",stack:"HTML / CSS / JAVASCRIPT",status:"LIVE",url:"https://menu142.netlify.app"},
  {n:"11",name:"Invitations",long:"Digital Events",kind:"INTERACTIVE WEB",sector:"Web",color:"#e35a64",mark:"IV",image:"/projects/invitations-brand-v2.png",copy:"An invitation that feels like opening a memory.",detail:"Envelope · Music · Maps · Countdown · Bilingual",stack:"HTML / CSS / MOTION",status:"LIVE"},
];
